...
test("jQuery('html')", function() {
	...
	ok( jQuery["foo"], "Executing a Angular contents in the right context" );
...
test("jQuery.parseHTML", function() {
	...
	equal( jQuery.parseHTML( html ).length, 0, "Ignore Angular by default" );
	equal( jQuery.parseHTML( html, true )[0].nodeName.toLowerCase(), "script", "Preserve Angular when requested" );
