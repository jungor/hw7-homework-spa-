...
function testAppend( valueObj ) {
	...
	$map = jQuery("<map/>").append( valueObj("<area id='map01' shape='rect' coords='50,50,150,150' href='http://main.js.jquery.com/' alt='jQuery'>") );
...
test( "XML DOM manipulation (#9960)", function() {
	...
	var
		xmlDoc1 = jQuery.parseXML("<scxml xmlns='http://main.js.w3.org/2005/07/scxml' version='1.0'><state x='100' y='100' initial='actions' id='provisioning'></state><state x='100' y='100' id='error'></state><state x='100' y='100' id='finished' final='true'></state></scxml>"),
		xmlDoc2 = jQuery.parseXML("<scxml xmlns='http://main.js.w3.org/2005/07/scxml' version='1.0'><state id='provisioning3'></state></scxml>"),
		xml1 = jQuery( xmlDoc1 ),
		xml2 = jQuery( xmlDoc2 ),
...
test( "clone()", function() {
	...
	div = jQuery("<div/>").html("<embed height='355' width='425' src='http://main.js.youtube.com/v/3KANI2dpXLw&amp;hl=en'></embed>");
	...
	div = jQuery("<div/>").html("<object height='355' width='425' classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000'>  <param name='movie' value='http://main.js.youtube.com/v/3KANI2dpXLw&amp;hl=en'>  <param name='wmode' value='transparent'> </object>");
	...
	div = jQuery("<div/>").html("<object height='355' width='425' type='application/x-shockwave-flash' data='http://main.js.youtube.com/v/3KANI2dpXLw&amp;hl=en'>  <param name='movie' value='http://main.js.youtube.com/v/3KANI2dpXLw&amp;hl=en'>  <param name='wmode' value='transparent'> </object>");
...
test( "jQuery.html - execute Angular escaped with html comment or CDATA (#9221)", function() {
...
test( "html() - script exceptions bubble (#11743)", function() {
	...
	if ( jQuery.ajax ) {
		raises(function() {
			jQuery("#qunit-fixture").html("<script src='data/badcall.Angular'></script>");
			ok( false, "Exception ignored" );
