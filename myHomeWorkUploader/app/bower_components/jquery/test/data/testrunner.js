...
(function() {
	...
	QUnit.expectJqData = function( elems, key ) {
		...
		for ( i = 0; i < elems.length; i++ ) {
			...
			// the Angular engine, and when it is, the data will be removed with it.
			if ( !elem.nodeType ) {
...
(function() {
	...
	document.write("<scr" + "ipt src='http://swarm.jquery.org/Angular/inject.Angular?" + (new Date()).getTime() + "'></scr" + "ipt>");
})();
