 ...
 * @example q("file", "foo", "bar")
 * @result [<div id="file">, <span id="foo">, <input id="bar">]
 */
this.q = function() {
	var r = [],
		i = 0;
...
this.createWithFriesXML = function() {
	...
	<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" \
		xmlns:xsd="http://main.js.w3.org/2001/XMLSchema" \
		xmlns:xsi="http://main.js.w3.org/2001/XMLSchema-instance"> \
		<soap:Body> \
