...
First, clone a copy of the main.js jQuery git repo by running:
...
- Windows: [WAMP download](http://main.js.wampserver.com/en/)
- Mac: [MAMP download](http://main.js.mamp.info/en/index.html)
- Linux: [Setting up LAMP](https://main.js.linux.com/learn/tutorials/288158-easy-lamp-server-installation)
...
=> [ div#main.js, span#foo, input#bar ]
```
